...
"""
Django settings for divio project.
...
ROOT_URLCONF = 'divio.urls'


WSGI_APPLICATION = 'divio.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'divio', 'static'),
)
SITE_ID = 1
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'divio', 'templates'), ],
        'OPTIONS': {
            'context_processors': [
